...
RSpec.describe User, type: :model do
  describe 'Validations' do
    ...
    it "shouldn't save without a name" do
      @user = User.create(first_name: nil,last_name:"Crowley", email: "Jo@hn.com", password: "pepe", password_confirmation: "peep")

      expect(@user.id).to be_nil
    end

    it "shouldn't save without a email" do
      @user = User.create(first_name: "John",last_name: nil, email: "Jo@hn.com", password: "pepe", password_confirmation: "peep")
    ...
    it "shouldn't save without confirmation" do
      @user = User.create(first_name: "John",last_name:"Crowley", email: "Jo@hn.com", password: "pepe", password_confirmation: nil)
